...
- ⏳ **US-P0-03 continued (UNPARKED)** — beta auth-model decided: **FE sends bearer on every call → gate everything**. **Batch 1 shipped 2026-07-23: the whole RL surface gated, debt 192 → 125 (−67).** Memory: `project_beta_auth_model`.
