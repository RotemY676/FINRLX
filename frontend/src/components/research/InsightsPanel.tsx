    ...
    >
      ...
      {phase === "ready" && insights && (
        <div>
          ...
          <footer className="mt-4 pt-3 border-t border-line space-y-2">
            ...
            {/* Phase 18.8 — Decision-support disclaimer.
                Required by the fintech-disclaimer-and-marketing-guard skill:
                every AI-generated investing-adjacent surface must visibly
                state that the output is research, not advice. We put it
                INSIDE the card (not in a global footer) so it can't be
                visually separated from the content it's qualifying. */}
            <div
              role="note"
              className="flex items-start gap-2 text-meta text-ink-3 bg-surface-2 border border-line rounded-md p-2 mt-2"
            >
              <Icon name="info" size={12} className="text-ink-4 mt-0.5 flex-shrink-0" />
              <p className="leading-snug">
                <strong className="text-ink-2">Decision support, not investment advice.</strong>{" "}
                These insights are AI-generated from public SEC filings and may contain
                errors or omissions. They are not a recommendation to buy, sell, or hold
                any security. Verify all figures against the original filings (linked
                above by accession number) before acting on them.
              </p>
            </div>
          </footer>
        </div>
