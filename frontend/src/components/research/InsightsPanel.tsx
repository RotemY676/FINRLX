    ...
    >
      ...
      {phase === "ready" && insights && (
        <div className="space-y-4">
          {/* Phase 18.6.1 — Multi-metric trajectory chart. Renders one
              small line chart per metric the LLM extracted. When the
              LLM didn't emit a valid JSON block (insights.metrics === null),
              the chart is hidden and only the narrative shows. */}
          {insights.metrics && insights.metrics.metrics.length > 0 && (
            <TrajectoryChart data={insights.metrics} />
          )}
