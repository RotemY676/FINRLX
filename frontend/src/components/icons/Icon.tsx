/**
 * Icon system ported from design/handoff-package/icons.jsx.
 * Stroke-only Lucide-style SVGs. ~40 icons.
 */
...
export function Icon({ name, size = 16, className = "", strokeWidth = 1.6, style }: IconProps) {
  const p = {
