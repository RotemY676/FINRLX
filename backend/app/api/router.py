...
from app.api.v1.ops_readiness import router as ops_readiness_router
...
from app.api.v1.research_documents import router as research_documents_router
from app.api.v1.research_edgar import router as research_edgar_router
...
api_router.include_router(overview_router, tags=["overview"], dependencies=_AUTHED)
api_router.include_router(analysis_router, tags=["analysis"], dependencies=_AUTHED)
api_router.include_router(autopilot_router, tags=["autopilot"])
api_router.include_router(price_freshness_router, tags=["prices"])
api_router.include_router(recommendations_router, tags=["recommendations"], dependencies=_AUTHED)
api_router.include_router(decision_router, tags=["decision"], dependencies=_AUTHED)
api_router.include_router(decision_packets_router, tags=["decision"])
api_router.include_router(comparison_router, tags=["comparison"], dependencies=_AUTHED)
api_router.include_router(replay_router, tags=["replay"], dependencies=_AUTHED)
...
api_router.include_router(scenario_router, tags=["scenario"], dependencies=_AUTHED)
api_router.include_router(actions_router, tags=["actions"], dependencies=_AUTHED)
api_router.include_router(pricechart_router, tags=["pricechart"], dependencies=_AUTHED)
api_router.include_router(data_health_router, tags=["ops"], dependencies=_AUTHED)
api_router.include_router(ingest_router, tags=["ingestion"], dependencies=_AUTHED)
api_router.include_router(features_router, tags=["features"], dependencies=_AUTHED)
api_router.include_router(pipeline_router, tags=["pipeline"], dependencies=_AUTHED)
api_router.include_router(publication_router, tags=["publication"], dependencies=_AUTHED)
...
api_router.include_router(ml_ops_router, tags=["ml-ops"], dependencies=_AUTHED)
api_router.include_router(policies_router, tags=["policies"], dependencies=_AUTHED)
api_router.include_router(profile_router, tags=["profile"])
api_router.include_router(integrations_router, tags=["integrations"], dependencies=_AUTHED)
...
api_router.include_router(risk_router, tags=["risk"], dependencies=_AUTHED)
api_router.include_router(news_router, tags=["news"], dependencies=_AUTHED)
...
api_router.include_router(research_fundamentals_router, tags=["research-fundamentals"], dependencies=_AUTHED)
api_router.include_router(research_documents_router, tags=["research-documents"], dependencies=_AUTHED)
api_router.include_router(research_edgar_router, tags=["research-edgar"], dependencies=_AUTHED)
